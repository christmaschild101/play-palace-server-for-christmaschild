...
virtual-bots-add = Añadir Bot Virtual
virtual-bots-edit = Editar Bot Virtual
virtual-bots-delete = Eliminar Bot Virtual
virtual-bots-add-prompt = Introduce un nombre para el nuevo bot virtual:
virtual-bots-rename-prompt = Introduce un nuevo nombre para { $name }:
virtual-bots-rename = Renombrar
virtual-bots-change-profile = Cambiar Perfil
virtual-bots-added = Bot virtual { $name } añadido y conectado.
virtual-bots-renamed = Bot virtual renombrado de { $old_name } a { $new_name }.
virtual-bots-profile-changed = Perfil del bot virtual { $name } cambiado a { $profile }.
virtual-bots-deleted = Bot virtual { $name } eliminado. { $tables } mesa(s) cerrada(s).
virtual-bots-name-taken = Ya existe un bot virtual con ese nombre.
virtual-bots-name-invalid = Ese nombre no es válido.
virtual-bots-no-bots = No hay bots virtuales que gestionar.
virtual-bots-delete-confirm = ¿Eliminar el bot virtual { $name }? Esto cerrará cualquier mesa en la que esté.
virtual-bots-no-profiles = No hay perfiles disponibles.
...
# Developer role
user-is-developer = { $player } es un desarrollador de PlayPalace.
promote-developer = Promover a Desarrollador
demote-developer = Degradar de Desarrollador
confirm-promote-developer = ¿Está seguro de que quiere promover a { $player } a desarrollador?
confirm-demote-developer = ¿Está seguro de que quiere degradar a { $player } de desarrollador?
promote-developer-announcement = ¡{ $player } ha sido promovido a desarrollador!
promote-developer-announcement-you = ¡Has sido promovido a desarrollador!
demote-developer-announcement = { $player } ha sido degradado de desarrollador.
demote-developer-announcement-you = Has sido degradado de desarrollador.
no-admins-to-promote-developer = No hay administradores disponibles para promover a desarrollador.
no-developers-to-demote = No hay desarrolladores disponibles para degradar.
promote-developer-unavailable = { $player } no puede ser promovido a desarrollador.
demote-developer-unavailable = { $player } no puede ser degradado de desarrollador.

# Virtual bots (bring specific bots online)
virtual-bots-fill-localization-in-progress = Mientras la localización esté en curso, no puede hacer que los bots se conecten.
virtual-bots-bring-online = Conectar un bot
virtual-bots-brought-online = El bot virtual { $name } se ha conectado.
virtual-bots-already-online = El bot virtual { $name } ya está conectado.
virtual-bots-all-online = Todos los bots virtuales ya están conectados.
virtual-bots-take-offline = Desconectar bot virtual
virtual-bots-taken-offline = Bot virtual { $name } desconectado.
virtual-bots-already-offline = El bot virtual { $name } ya está desconectado.
virtual-bots-all-offline = Todos los bots virtuales ya están desconectados.
...
cah-content-notice = Este juego contiene contenido muy inmaduro. No se recomienda para jugadores menores de 16 años ni para personas sensibles a ciertos temas.
cah-keep-playing = Seguir jugando
cah-go-back = Volver
...
# Server freeze
freeze-server = Congelar servidor
unfreeze-server = Descongelar servidor
confirm-freeze-server = ¿Seguro que quieres congelar el servidor? Los jugadores no podrán hacer nada hasta que un administrador lo descongele.
server-frozen = El servidor ha sido congelado por un administrador. No se puede realizar ninguna acción hasta que el servidor se descongele.
server-unfrozen = El servidor ha sido descongelado. La actividad normal puede reanudarse.
server-frozen-notice = El servidor está actualmente congelado por un administrador. Por favor, espera.
