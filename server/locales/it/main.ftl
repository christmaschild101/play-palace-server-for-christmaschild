...
virtual-bots-fill-localization-in-progress = Mentre la localizzazione è in corso, non puoi portare online i bot.
virtual-bots-bring-online = Metti un bot online
virtual-bots-brought-online = Il bot virtuale { $name } è ora online.
virtual-bots-already-online = Il bot virtuale { $name } è già online.
virtual-bots-all-online = Tutti i bot virtuali sono già online.
virtual-bots-take-offline = Metti bot offline
virtual-bots-taken-offline = Il bot virtuale { $name } è stato portato offline.
virtual-bots-already-offline = Il bot virtuale { $name } è già offline.
virtual-bots-all-offline = Tutti i bot virtuali sono già offline.
...
cah-content-notice = Questo gioco contiene contenuti molto immaturi. Non è consigliato a giocatori sotto i 16 anni o sensibili a determinati argomenti.
cah-keep-playing = Continua a giocare
cah-go-back = Indietro
...
# Server freeze
freeze-server = Congela server
unfreeze-server = Scongela server
confirm-freeze-server = Sei sicuro di voler congelare il server? I giocatori non potranno fare nulla finché un amministratore non lo scongela.
server-frozen = Il server è stato congelato da un amministratore. Nessuna azione può essere eseguita finché il server non viene scongelato.
server-unfrozen = Il server è stato scongelato. L'attività normale può riprendere.
server-frozen-notice = Il server è attualmente congelato da un amministratore. Attendere prego.
