...
virtual-bots-take-offline = ボットをオフラインにする
virtual-bots-taken-offline = 仮想ボット { $name } をオフラインにしました。
virtual-bots-already-offline = 仮想ボット { $name } はすでにオフラインです。
virtual-bots-all-offline = すべての仮想ボットはすでにオフラインです。
...
cah-content-notice = このゲームには非常に未熟な内容が含まれています。16歳未満のプレイヤーや特定の話題に敏感な方にはお勧めできません。
cah-keep-playing = プレイを続ける
cah-go-back = 戻る
