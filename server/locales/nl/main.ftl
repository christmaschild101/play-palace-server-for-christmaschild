...
virtual-bots-take-offline = Bot offline halen
virtual-bots-taken-offline = Virtuele bot { $name } is offline gehaald.
virtual-bots-already-offline = Virtuele bot { $name } is al offline.
virtual-bots-all-offline = Alle virtuele bots zijn al offline.
