...
virtual-bots-add = Добавить виртуального бота
virtual-bots-edit = Изменить виртуального бота
virtual-bots-delete = Удалить виртуального бота
virtual-bots-add-prompt = Введите имя для нового виртуального бота:
virtual-bots-rename-prompt = Введите новое имя для { $name }:
virtual-bots-rename = Переименовать
virtual-bots-change-profile = Сменить профиль
virtual-bots-added = Виртуальный бот { $name } добавлен и подключён онлайн.
virtual-bots-renamed = Виртуальный бот переименован с { $old_name } на { $new_name }.
virtual-bots-profile-changed = Профиль виртуального бота { $name } изменён на { $profile }.
virtual-bots-deleted = Виртуальный бот { $name } удалён. Закрыто { $tables } стол(столов).
virtual-bots-name-taken = Виртуальный бот с таким именем уже существует.
virtual-bots-name-invalid = Это имя недействительно.
virtual-bots-no-bots = Нет виртуальных ботов для управления.
virtual-bots-delete-confirm = Удалить виртуального бота { $name }? Это закроет любой стол, за которым он находится.
virtual-bots-no-profiles = Нет доступных профилей.

localization-in-progress-try-again = Локализация ещё загружается. Пожалуйста, попробуйте снова через минуту.

# Server reboot
admin-reboot-server = Перезапустить сервер
confirm-reboot-server = Вы уверены, что хотите перезапустить сервер? Все игроки будут отключены и снова подключены.
server-reboot-warning = Сервер перезапустится через { $seconds } секунд.
server-restarting = Сервер перезапускается. Вы будете автоматически переподключены.
server-reboot-failed = Не удалось перезапустить сервер. Попробуйте еще раз.
# Admin: server status
...
# Developer role
user-is-developer = { $player } является разработчиком PlayPalace.
promote-developer = Назначить разработчиком
demote-developer = Снять с разработчика
confirm-promote-developer = Вы уверены, что хотите назначить { $player } разработчиком?
confirm-demote-developer = Вы уверены, что хотите снять { $player } с разработчика?
promote-developer-announcement = { $player } назначается разработчиком!
promote-developer-announcement-you = Вы назначены разработчиком!
demote-developer-announcement = { $player } снят с разработчика.
demote-developer-announcement-you = Вы сняты с разработчика.
no-admins-to-promote-developer = Нет доступных администраторов для назначения разработчиком.
...
virtual-bots-take-offline = Отключить бота
virtual-bots-taken-offline = Виртуальный бот { $name } отключён.
virtual-bots-already-offline = Виртуальный бот { $name } уже офлайн.
virtual-bots-all-offline = Все виртуальные боты уже офлайн.
...
cah-content-notice = Эта игра содержит очень незрелый контент. Она не рекомендуется игрокам младше 16 лет или людям, чувствительным к определённым темам.
cah-keep-playing = Продолжить игру
cah-go-back = Назад
...
# Server freeze
freeze-server = Заморозить сервер
unfreeze-server = Разморозить сервер
confirm-freeze-server = Вы уверены, что хотите заморозить сервер? Игроки не смогут ничего делать, пока администратор не разморозит его.
server-frozen = Сервер был заморожен администратором. Никакие действия не могут быть выполнены, пока сервер не разморожен.
server-unfrozen = Сервер был разморожен. Нормальная активность может возобновиться.
server-frozen-notice = Сервер в настоящее время заморожен администратором. Пожалуйста, подождите.
