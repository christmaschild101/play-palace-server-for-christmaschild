...
# Server reboot
admin-reboot-server = Znova zaženi strežnik
confirm-reboot-server = Ali ste prepričani, da želite znova zagnati strežnik? Vsi igralci bodo odklopljeni in znova povezani.
...
virtual-bots-fill-localization-in-progress = Medtem ko lokalizacija poteka, botov ne morete pripeljati v splet.
virtual-bots-bring-online = Pripeľji bota v splet
virtual-bots-brought-online = Virtualni bot { $name } je pripeljan v splet.
virtual-bots-already-online = Virtualni bot { $name } je že v spletu.
virtual-bots-all-online = Vsi virtualni boti so že v spletu.
virtual-bots-take-offline = Izklopi bota
virtual-bots-taken-offline = Virtualni bot { $name } je bil izklopljen.
virtual-bots-already-offline = Virtualni bot { $name } je že izklopljen.
virtual-bots-all-offline = Vsi virtualni boti so že izklopljeni.
...
cah-content-notice = Ta igra vsebuje zelo nezrelo vsebino. Ni priporočljiva igralcem, mlajšim od 16 let, ali osebam, občutljivim na določene teme.
cah-keep-playing = Nadaljuj igro
cah-go-back = Nazaj
...
# Server freeze
freeze-server = Zamrzni strežnik
unfreeze-server = Odmrzni strežnik
confirm-freeze-server = Ali ste prepričani, da želite zamrzniti strežnik? Igralci ne bodo mogli storiti ničesar, dokler ga administrator ne odmrznе.
server-frozen = Strežnik je zamrznil administrator. Nobenega dejanja ni mogoče izvesti, dokler se strežnik ne odmrznе.
server-unfrozen = Strežnik je bil odmrznjen. Običajna dejavnost se lahko nadaljuje.
server-frozen-notice = Strežnik trenutno zamrzuje administrator. Počakajte prosim.
